...
class Amazon():
    ...
    def create_filter_list(self):from bs4 import BeautifulSoup
import requests
import time
import datetime
import smtplib
...
class Amazon():
    ...
    def create_filter_list(self):
        for i in self.divs: # Itera en los divs de la página y extra la información
            ...
            self.array_products.append({"nombre": producto.text, "precio": price})
    
producto = Amazon("calculadora")

print(producto.divs)
print(len(producto.divs))
    
producto = Amazon("calculadora")

print(producto.divs)
print(len(producto.divs))
producto.create_filter_list()
print(producto.array_products)